...
import {  useDeleteHolidayMutation, useGetAllHolidayQuery } from '../../redux/features/holiday/holidayApi';
...
const {data}=useGetAllHolidayQuery()
const {data:userData}=useLoadUserQuery();
const navigate=useNavigate();
const [deleteHoliday,{isSuccess, data:deleteData, error}]=useDeleteHolidayMutation();
...
const columns=[
  ...
  { field: "description", headerName: "Description", flex: 0.5, minWidth: 50 },
 {
      field: "edit",
      headerName: "Edit",
      flex: 0.5,
